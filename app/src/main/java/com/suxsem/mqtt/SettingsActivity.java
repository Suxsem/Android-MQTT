...
public class SettingsActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (password.length() > 0)
            passwordEdit.setHint(getString(R.string.password_not_changed));
        else
            passwordEdit.setHint(getString(R.string.password));
    ...
    class Encrypt extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progress = ProgressDialog.show(activity, null, getString(R.string.saving), true);
        }
